...
const ScrollConfig title1Conf     PROGMEM = {{ TFT_FRAMEWDT, 50, 2, WA_LEFT }, 140, true, MAX_WIDTH-4, 5000, 4, 30 };
const ScrollConfig title2Conf     PROGMEM = {{ TFT_FRAMEWDT, 70, 2, WA_LEFT }, 140, true, MAX_WIDTH-4, 5000, 4, 30 };
...
const ScrollConfig weatherConf    PROGMEM = {{ 8, 87, 2, WA_LEFT }, 140, false, MAX_WIDTH-2, 0, 4, 30 };
...
const WidgetConfig vuConf         PROGMEM = { TFT_FRAMEWDT, 198, 1, WA_CENTER };
...
const VUBandsConfig bandsConf     PROGMEM = { 100, 10, 4, 2, 10, 2 };
