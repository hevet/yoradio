...
const ScrollConfig weatherConf    PROGMEM = {{ TFT_FRAMEWDT+28, 64-11, 1, WA_LEFT }, 140, false, DSP_WIDTH/2-8, 0, 2, 25 }; // ПОГОДА!!
...
const WidgetConfig  iptxtConf     PROGMEM = { TFT_FRAMEWDT+44, 64-22, 1, WA_LEFT };
const WidgetConfig   rssiConf     PROGMEM = { TFT_FRAMEWDT+28, 64-22, 1, WA_LEFT };
const WidgetConfig numConf        PROGMEM = { TFT_FRAMEWDT+130, 57, 0, WA_LEFT };
...
const BitrateConfig fullbitrateConf PROGMEM = {{2, 40, 1, WA_LEFT}, 21 };
