...
const ScrollConfig metaConf       PROGMEM = {{ TFT_FRAMEWDT+1, TFT_FRAMEWDT+1, 1, WA_LEFT }, 140, true, MAX_WIDTH-1, 5000, 2, 25 };
const ScrollConfig title1Conf     PROGMEM = {{ 2, 13, 1, WA_LEFT }, 140, true, DSP_WIDTH-1, 5000, 1, 25 };
const ScrollConfig title2Conf     PROGMEM = {{ 2, 22, 1, WA_LEFT }, 140, true, DSP_WIDTH-1, 5000, 1, 25 };
...
const ScrollConfig weatherConf    PROGMEM = {{ 0, 64-11, 1, WA_LEFT }, 140, false, DSP_WIDTH-6*4, 0, 1, 25 }; // ПОГОДА!!
...
const WidgetConfig bitrateConf    PROGMEM = { 2, 37, 1, WA_LEFT };
